...
using Zaposleni_Blazor.Components;
...
//Razlika izmeðu AddSingleton i AddTransient u ASP.NET Core-u odnosi se na životni vek (lifetime)
//Ove metode definišu koliko dugo instanca servisa treba da traje, odnosno koliko puta se kreira novi objekat servisa tokom trajanja aplikacije.

//AddSingleton servis se kreira JEDNOM i ta INSTANCA se DELI kroz CELO trajanje aplikacije.
//Kada registrujete servis sa AddSingleton, svaki zahtev za tim servisom æe dobiti ISTU instancu. Ova instanca se stvara prilikom PRVOG zahteva i koristi se sve dok aplikacija ne bude ugašena.
//Pogodno za: Servise koji su skupi za kreiranje ili treba da drže stalno stanje (npr. konfiguracije, cache-ovi, baze podataka sa jednim konekcijama).

//AddTransient servis se kreira SVAKI PUT kada se zatraži.
//Kada registrujete servis sa AddTransient, svaki zahtev za tim servisom æe dobiti NOVU instancu. Ova instanca se stvara svaki put kada se zatraži.
